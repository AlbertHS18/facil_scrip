			...
			<div class="col-md-6 offset-md-3 mt-5">
				...
				<form class="form" action="/" method="POST">
					<div class="form-group">
						...
						<input class="form-control" type="text" name="nombre" id="nombre" required value="" autocomplete="off">
					</div>

					<div class="form-group">
						<label class="apellido">Apellido: <strong class="text-danger"><small>*</small></strong></label>
						<input class="form-control" type="text" name="apellido" id="apellido" required value="" autocomplete="off">
					</div>

					<div class="form-group">
						<label class="correo">Correo: <strong class="text-danger"><small>*</small></strong></label>
						<input class="form-control" type="text" name="correo" id="correo" required value="" autocomplete="off">
					</div>
